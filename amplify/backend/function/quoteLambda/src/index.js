/* Amplify Params - DO NOT EDIT
	API_QUOTES_GRAPHQLAPIIDOUTPUT
	API_QUOTES_QUOTEAPPDATATABLE_ARN
	API_QUOTES_QUOTEAPPDATATABLE_NAME
	ENV
	REGION
Amplify Params - DO NOT EDIT */
...
async function updateQuoteDDBObject() {
    const quoteTableName = process.env.API_QUOTES_QUOTEAPPDATATABLE_NAME;
    ...
    async function getRandomQuote(apiURLInput) {
        ...
        const svgImage = `
          <svg width="${width}" height="${height}">
              ...
              <text x="${width / 2}" y="${
          height - 10
        }" class="footerStyles">Developed by Tanner Mills | Quotes from ZenQuotes.io</text>
          </svg>
        `;
      
        //  Add background images for the svg creation
        const backgroundImages = [
          "backgrounds/Hydrogen750x500.png",
          "backgrounds/Kimoby_Is_The_New_Blue750x500.png",
          "backgrounds/Lawrencium750x500.png",
          "backgrounds/Moonlit_Asteroid750x500.png",
        ];
