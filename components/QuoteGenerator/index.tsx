...
import { ModalCircularProgress, QuoteGeneratorCon, QuoteGeneratorModalCon, QuoteGeneratorModalInnerCon, QuoteGeneratorSubTitle, QuoteGeneratorTitle } from './QuoteGeneratorElements';
import ImageBlob from '../animations/ImageBlob';
import { ImageBlobCon } from '../animations/amimationElements';
...
const QuoteGeneratorModal = ({
    ...
    // Function: Handling the download of the quote card
    ...
    //Function: Handle the receiving of the quote card
    useEffect(() => {
        if (quoteReceived) {
  ...
  return (
    <Modal
       ...
       aria-description="spring-modal-opens-and-closes-quote-generator"
       open={open}
       onClose={close}
